                ...
                <form action="">
                    ...
                    <div className="flex flex-col">
                        ...
                        <select name="Tancter" id="TancterID">
                            <option value="kis tánctér(30-40 &#13217;)">kis tánctér(30-40 &#13217;)</option>
                            <option value="közepes tánctér(50-70 &#13217;)">közepes tánctér(50-70 &#13217;)</option>
                            <option value="csarnok(80+ &#13217;)">csarnok(80+ &#13217;)</option>
                        </select>
                    </div>
                    <div className="flex flex-col">
                        <p className="font-bold">
